...
An interactive, futuristic birthday prank web experience with stunning visual effects, animations, and surprise reveals. This project creates a playful birthday celebration for "Paroooo " with a fun prank button that runs away from the user before revealing birthday surprises.
...
### Multi-Phase Reveals
1. **Phase 1 - Sprite Prank**: Initial humorous reveal with a sprite gift
...
### Audio Integration
- First reveal sound effect (Sprite reveal)
...
Funny BIRTHDAY/
├── index.html
├── karela.png          (Image: Sprite gift)
├── Paroooo.jpeg        (Image: Birthday person's photo)
...
3. **Sprite Reveal**: After 15 attempts, clicking reveals a humorous sprite gift (6 seconds)
...
<h1 id="main-title">Hey Paroooo aproo!</h1>
<h1>Happy birthday Paroo</h1>
<h1>Happy birthday Paroo</h1>
```
...
Created with ❤️ for Paroooo's birthday celebration
